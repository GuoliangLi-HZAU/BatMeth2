...
void Parse_Command_line(int argc, char* argv[],char* & GENOME,unsigned & MAXCOUNT,FMFILES & F,BATPARAMETERS & BP)
{
	...
	const char* Short_Options ="C:c:e:E:d:D:f:F:x:X:s:ShHi:b:l::L:o:g:Pr:t:m:M:n:NbBw::R:Uu:v:Zj:p:IO";//allowed options....
...
//	fprintf(stderr,"----------------------------------------------------------------------\n\n");
	...
	fprintf(stderr,"                                    Because the sequencing library was constructed in a strand-specific manner usually. if also assigned '-O' then Only_non_directional.\n");
