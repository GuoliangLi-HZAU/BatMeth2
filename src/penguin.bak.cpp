...
void Map_One_SEG_Head(std::set<unsigned> & AM,int mismatch,READ & RawR,char source,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,BATREAD & B,unsigned & Conversion_Factor,MEMX & MF,MEMX & MC,LEN & L,unsigned & Actual_Tag,Final_Hit &  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,bool PRINT,Hit_Info & H,int & Quality_Score,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE);
void Map_One_SEG_Tail(std::set<unsigned> & AM,int mismatch,READ & RawR,char source,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,BATREAD & B,unsigned & Conversion_Factor,MEMX & MF2,MEMX & MC2,LEN & L,unsigned & Actual_Tag,Final_Hit &  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,bool PRINT,Hit_Info & H,int & Quality_Score,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE);
...
void Mapping_New(int & Paired_Ncutoff,char source1,char source2,READ & RawR,READ & RawM,int Read_Length,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,READ & M,BATREAD & B,unsigned & Conversion_Factor,MEMX & mF,MEMX & mC,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,FILE*  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,Pair* & Pairs,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_Mid,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_Mid,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_End,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_End,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_Mid_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_Mid_P,std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut);
void Two_Side_Hit_Finding(int & Paired_Ncutoff,char source1,char source2,READ & RawR,READ & RawM,int Read_Length,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,READ & M,BATREAD & B,unsigned & Conversion_Factor,MEMX & mF,MEMX & mC,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,FILE*  Single_File,FILE* Mishit_File,Align_Hit & Align_Hits,Align_Hit & Align_Hits_P,Pair* & Pairs,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE,std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut);
...
void Mapping(char source1,char source2,READ & RawR,READ & RawM,int Read_Length,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,READ & M,BATREAD & B,unsigned & Conversion_Factor,MEMX & mF,MEMX & mC,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,
	LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,FILE*  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,Pair* & Pairs,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_Mid,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_Mid,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_End,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_End,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_Mid_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_Mid_P,
	std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut);
void Mapping_Batmis(int & Paired_Score,char source1,char source2,READ & R,READ & M,BATREAD & B,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & mF,MEMX & mC,LEN & L_batmeth,BWT* fwfmi,BWT* revfmi,READ & RawR,READ & RawM,Align_Hit & Align_Hits,Align_Hit & Align_Hits_P,OUTPUT & O1,OUTPUT & O2,unsigned char* Original_Text,FILE*  Single_File,std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut,
...
void Map_One_Seg(READ & RawR,char source,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,BATREAD & B,unsigned & Conversion_Factor,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,Final_Hit &  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,Pair* & Pairs,bool PRINT,Hit_Info & H,int & Quality_Score,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE);
bool Map_One_Seg_New(int & mis_ID,int & mismatch,int & step,READ & RawR,char source,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,BATREAD & B,unsigned & Conversion_Factor,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,Final_Hit &  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,Pair* & Pairs,bool PRINT,Hit_Info & H,int & Quality_Score,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE);
...
bool Proper_Pair_New(bool & Do_Rescue,bool & realign,std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut,READ & RawR,READ & RawM,unsigned char* Original_Text,BWT* fwfmi,BWT* revfmi,char source1,char source2,READ & RTemp,READ & RTemp_P,BATREAD & BTemp,BATREAD & BTemp_P,int Read_Length,int Read_Length2,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment>  & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment>  & Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment>  & Good_Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment>  & Good_Alignments_P,Hit_Info & H1,Hit_Info & H1_P,FILE* Single_File,int Quality_Score1,int Quality_Score1_P,Alignment & A1,Alignment & A1_P,MEMX & MF,MEMX & MC,bool Max_Pass);
...
//Read Head start ..
		...
		RawMead=M_CT=M_Rev_CT=M_Rev_GA=M_GA=M;
	//printf("\n%s\n",R.Description);	
...
//if(!ESTIMATE) printf("\n%s\n",R.Description);
		...
		Mapping_Batmis(Paired_Score,'1','3',R_CT,M_GA,B_batmeth,MF_CT,MC_CT,MF_CT2,MC_CT2,mF_CT,mC_CT,L_batmeth,fwfmiCT,revfmiCT,R,M,Align_Hits_CT,Align_Hits_CT_P,O_CT,O_RevCT,Original_Text_CT,Single_File,Alignments_Reslut,MFLH_CT,MCLH_CT,MFLT_CT,MCLT_CT,MFH_CT,MCH_CT,MFT_CT,MCT_CT, L,L_Main,L_Half,L_Third,Actual_Tag,Mishit_File,Pairs,Conversion_Factor,Entries_CT,RQHALF_CT,RQ_CT);
		if(!Alignments_Reslut.empty() && !ESTIMATE )
                {    
                        Alignment_Pair pai=Alignments_Reslut.top();
			if(pai.paired) Paired_Score=pai.Score;
		//	printf("\ncccccccccc %d\n",pai.Score);
                        if(pai.paired && ( (pai.Mismatch<=3 && pai.Indel==0) || (pai.Mismatch<=1 && pai.Indel<=1) ) )
                        {       ntemp++;
			//	int Sub_Score=INT_MAX;Alignments_Reslut.pop();
                         //       if(Alignments_Reslut.size()>0) Sub_Score=Alignments_Reslut.top().Score;
                         //       if(pai.Score==Sub_Score)
                         //       {
                         //               pai.Q1=0;pai.Q2=0;
                         //       }

                                fprintf(Single_File,"@\n%s\t%s\t%s\n%c\t%s\t%d\t%u\t%d\t%d\t%s\t%d\t%s\t%u\t%d\t%d\n",pai.Description1,R.Tag_Copy,R.Quality,pai.source1,pai.chrom1,pai.Flag1,pai.Loc1,pai.Mismatch1,pai.ReadLen1,pai.Cigar1.c_str(),pai.Q1,(pai.Same_Chrom? "=":pai.chrom2),pai.Loc2,pai.Insert_Size,pai.Q1);// ,H.Score,H.Sub_Opt_Score,H.QScore,H.SW_Score,H.SW_Sub_Opt_Score,RGID.c_str());

                                fprintf(Single_File,"@\n%s\t%s\t%s\n",pai.Description2,M.Tag_Copy,M.Quality);
                                fprintf(Single_File,"%c\t%s\t%d\t%u\t%d\t%d\t%s\t%d\t%s\t%u\t%d\t%d\n",pai.source2,pai.chrom2,pai.Flag2,pai.Loc2,pai.Mismatch2,pai.ReadLen2,pai.Cigar2.c_str(),pai.Q2,(pai.Same_Chrom? "=":pai.chrom1),pai.Loc1,-pai.Insert_Size,pai.Q2);
                                continue;
                        }    
                }
//if(!ESTIMATE) printf("222\n");
		Mapping_Batmis(Paired_Score,'4','2',R_CT,M_GA,B_batmeth,MF_GA,MC_GA,MF_GA2,MC_GA2,mF_GA,mC_GA,L_batmeth,fwfmiGA,revfmiGA,R,M,Align_Hits_GA,Align_Hits_GA_P,O_RevGA,O_GA,Original_Text_GA,Single_File,Alignments_Reslut,MFLH_GA,MCLH_GA,MFLT_GA,MCLT_GA,MFH_GA,MCH_GA,MFT_GA,MCT_GA,L,L_Main,L_Half,L_Third,Actual_Tag,Mishit_File,Pairs,Conversion_Factor,Entries_GA,RQHALF_GA,RQ_GA);
		if(ESTIMATE) continue;
		
		if(!Alignments_Reslut.empty() && !ESTIMATE )
                {    
                        Alignment_Pair pai=Alignments_Reslut.top();
//			printf("\nddddddddddd %d %d %d %d\n",pai.Score,pai.paired,pai.Mismatch1,pai.Mismatch2,pai.Indel);
                        if(pai.paired && ( (pai.Mismatch<=3 && pai.Indel==0) || (pai.Mismatch<=1 && pai.Indel<=1) ) ) //pai.Mismatch1<=2 && pai.Mismatch2<=2)
                        {
			 	ntemp++;   
	                //        int Sub_Score=INT_MAX;Alignments_Reslut.pop();
	                //        if(Alignments_Reslut.size()>0) Sub_Score=Alignments_Reslut.top().Score;
...
//continue;
		//===Init 2
		//R.batmeth1=false;M.batmeth1=false;R_CT.batmeth1=false;M_GA.batmeth1=false;
		int Paired_Ncutoff=INT_MAX;
		ReplaceCtoT(R_CT);ReplaceGtoA(M_GA);//CTread1 GAread2 CTgenome
//	printf("\n%s %s %s %s\n",R.Tag_Copy,M.Tag_Copy,R_CT.Tag_Copy,M_GA.Tag_Copy);
//		Mapping_New(Paired_Ncutoff,'1','3',R,M,Read_Length,RQHALF_CT,RQ_CT,Original_Text_CT,Entries_CT,fwfmiCT,revfmiCT,R_CT,M_GA,B,Conversion_Factor,mF_CT,mC_CT,MF_CT,MC_CT,MF_CT2,MC_CT2,MFLH_CT,MCLH_CT,MFLT_CT,MCLT_CT,MFH_CT,MCH_CT,MFT_CT,MCT_CT, L,L_Main,L_Half,L_Third,Actual_Tag,Single_File,Mishit_File,Alignments,Good_Alignments,Pairs,0,SEG_SIZE,SHIFT_SEG_SIZE,Alignments_Mid,Good_Alignments_Mid,Alignments_End, Good_Alignments_End,Alignments_P,Good_Alignments_P,Alignments_Mid_P,Good_Alignments_Mid_P,Alignments_Reslut);
//if(!ESTIMATE)  printf("333\n");
		Two_Side_Hit_Finding(Paired_Ncutoff,'1','3',R,M,Read_Length,RQHALF_CT,RQ_CT,Original_Text_CT,Entries_CT,fwfmiCT,revfmiCT,R_CT,M_GA,B,Conversion_Factor,mF_CT,mC_CT,MF_CT,MC_CT,MF_CT2,MC_CT2,MFLH_CT,MCLH_CT,MFLT_CT,MCLT_CT,MFH_CT,MCH_CT,MFT_CT,MCT_CT, L,L_Main,L_Half,L_Third,Actual_Tag,Single_File,Mishit_File,Align_Hits_CT,Align_Hits_CT_P,Pairs,0,SEG_SIZE,SHIFT_SEG_SIZE,Alignments_Reslut);

		if(!Alignments_Reslut.empty() && !ESTIMATE )
		{
			Alignment_Pair pai=Alignments_Reslut.top();
//printf("\nbbbbbbbbb %d\n",pai.Score);
			if(pai.paired && ( (pai.Mismatch<=4 && pai.Indel==0) || (pai.Mismatch<=2 && pai.Indel<=1) || (pai.Mismatch==0 && pai.Indel<=2) ) )
			{
			//	int Sub_Score=INT_MAX;Alignments_Reslut.pop();
                         //       if(Alignments_Reslut.size()>0) Sub_Score=Alignments_Reslut.top().Score;
                        //        if(pai.Score==Sub_Score)
		...
		//-------------------------------4 2-------------------------------------------------
		//ReplaceCtoT(R_CT);ReplaceGtoA(M_GA);//CTread1 GAread2 GAgenome
		//Mapping_New(Paired_Ncutoff,'4','2',R,M,Read_Length,RQHALF_GA,RQ_GA,Original_Text_GA,Entries_GA,fwfmiGA,revfmiGA,R_CT,M_GA,B,Conversion_Factor,mF_GA,mC_GA,MF_GA,MC_GA,MF_GA2,MC_GA2,MFLH_GA,MCLH_GA,MFLT_GA,MCLT_GA,MFH_GA,MCH_GA,MFT_GA,MCT_GA,L,L_Main,L_Half,L_Third,Actual_Tag,Single_File,Mishit_File,Alignments,Good_Alignments,Pairs,0,SEG_SIZE,SHIFT_SEG_SIZE,Alignments_Mid,Good_Alignments_Mid,Alignments_End, Good_Alignments_End,Alignments_P,Good_Alignments_P,Alignments_Mid_P,Good_Alignments_Mid_P,Alignments_Reslut);
//if(!ESTIMATE) printf("444\n");
		Two_Side_Hit_Finding(Paired_Ncutoff,'4','2',R,M,Read_Length,RQHALF_GA,RQ_GA,Original_Text_GA,Entries_GA,fwfmiGA,revfmiGA,R_CT,M_GA,B,Conversion_Factor,mF_GA,mC_GA,MF_GA,MC_GA,MF_GA2,MC_GA2,MFLH_GA,MCLH_GA,MFLT_GA,MCLT_GA,MFH_GA,MCH_GA,MFT_GA,MCT_GA,L,L_Main,L_Half,L_Third,Actual_Tag,Single_File,Mishit_File,Align_Hits_GA,Align_Hits_GA_P,Pairs,0,SEG_SIZE,SHIFT_SEG_SIZE,Alignments_Reslut);
...
//			printf("\naaaaa %d\n",pai.Score);
			...
			//	int Sub_Score=INT_MAX;
				...
				fprintf(Single_File,"@\n%s\t%s\t%s\n%c\t%s\t%d\t%u\t%d\t%d\t%s\t%d\t%s\t%u\t%d\t%d\n",pai.Description1,R.Tag_Copy,R.Quality,pai.source1,pai.chrom1,pai.Flag1,pai.Loc1,pai.Mismatch1,pai.ReadLen1,pai.Cigar1.c_str(),/*pai.QualityScore/2*/pai.Q1,(pai.Same_Chrom? "=":pai.chrom2),pai.Loc2,pai.Insert_Size,pai.Q1);// ,H.Score,H.Sub_Opt_Score,H.QScore,H.SW_Score,H.SW_Sub_Opt_Score,RGID.c_str());

				fprintf(Single_File,"@\n%s\t%s\t%s\n",pai.Description2,M.Tag_Copy,M.Quality);
				fprintf(Single_File,"%c\t%s\t%d\t%u\t%d\t%d\t%s\t%d\t%s\t%u\t%d\t%d\n",pai.source2,pai.chrom2,pai.Flag2,pai.Loc2,pai.Mismatch2,pai.ReadLen2,pai.Cigar2.c_str(),/*pai.QualityScore/2*/pai.Q2,(pai.Same_Chrom? "=":pai.chrom1),pai.Loc1,-pai.Insert_Size,pai.Q2);
			}else 
			{
                                ...
                                fprintf(Single_File,"@\n%s\t%s\t%s\n",pai.Description1,PrintR2.Tag_Copy,PrintR2.Quality);
                                fprintf(Single_File,"%c\t%s\t%d\t%u\t%d\t%d\t%s\t%d\t*\n",pai.source1,pai.chrom1,pai.Flag1,pai.Loc1,pai.Mismatch1,pai.ReadLen1,pai.Cigar1.c_str(),pai.QualityScore);// ,H.Score,H.Sub_Opt_Score,H.QScore,H.SW_Score,H.SW_Sub_Opt_Score,RGID.c_str());
                                
                                fprintf(Single_File,"@\n%s\t%s\t%s\n",PrintR.Description,PrintR.Tag_Copy,PrintR.Quality);
                                //fprintf(Single_File,"%c\t*\t0\t0\t0\t%d\t*\t0\t*\n",source2,PrintR.Real_Len);// ,H.Score,H.Sub_Opt_Score,H.QScore,H.SW_Score,H.SW_Sub_Opt_Score,RGID.c_str());
			}
//			}//rm
		}
	}
...
int Map_hy_X(Alignment & A1,char & source1,READ & RawR,READ & R,BATREAD & B,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,Pair* & Pairs,unsigned char* Original_Text,BWT* fwfmi,BWT* revfmi,unsigned & Conversion_Factor,unsigned Entries,RQINDEX & RQHALF,RQINDEX & RQ)
{
	MF.batmeth1=false;MC.batmeth1=false;
	int MapQ1=1;
	int SEG_SIZE=75;
	int Read_Length=R.Real_Len;
	if(SEG_SIZE>=Read_Length) SEG_SIZE=Read_Length-1;
	A1.Loc=UINT_MAX;
	Hit_Info H1;int Quality_Score1;
	L_Main.STRINGLENGTH=SEG_SIZE;
	B.StringLength=L.STRINGLENGTH;
	int Half=50;
	Split_Read(Half,L_Half);
	Split_Read(SEG_SIZE/3,L_Third);
	Final_Hit Head_Hit;

	int m1=0;int step1=1;int mism_ID1=0;
	while(m1<=2 && !Map_One_Seg_New(mism_ID1,m1,step1,RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,MF2,MC2,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Head_Hit,Mishit_File,Alignments,Good_Alignments,Pairs,false,H1,Quality_Score1,0,SEG_SIZE,0))
        {
        	m1++;
                step1=1;
        }

	//Map_One_Seg(0,0,0,RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,MF2,MC2,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Head_Hit,Mishit_File,Alignments,Good_Alignments,Pairs,false,H1,Quality_Score1,0,SEG_SIZE,0);
	int cutoff=(MAX_MISMATCHES+5)*30+10;
	Get_top1M_Alignments(Alignments,Good_Alignments, cutoff);
	Get_Basic_MapQ(Good_Alignments,A1,MapQ1);
	MF.batmeth1=true;MC.batmeth1=true;
	return MapQ1;
}

void Detect_Paired(unsigned char* Original_Text,int & MapQ1,int & MapQ1_P,char source1,char source2,READ & RawR,READ & RawM,BWT* fwfmi,BWT* revfmi,READ & R,READ & M,BATREAD & B,BATREAD & B_P,MEMX & mF,MEMX & mC,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_P,FILE*  Single_File,Alignment & A1,Alignment & A1_P,std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut)
{
	bool Max_Pass=true;
	int Read_Length=R.Real_Len;
	...
	if(!(MapQ1 == -1 && MapQ1_P== -1))//if at least one end mapped 
	{
		...
		{
			if(Proper_Pair(Alignments_Reslut,RawR,RawM,Original_Text,fwfmi,revfmi,source1,source2,R,M,B,B_P,Read_Length,Read_Length2,Alignments,Alignments_P,Good_Alignments,Good_Alignments_P,H1,H1_P,Single_File,Quality_Score1,Quality_Score1_P,A1,A1_P,mF,mC,Max_Pass))
			{
				return;
			}
		}
		...
		{
			Full_Rescue(Alignments_Reslut,RawR,RawM,Original_Text,source1,source2,R,M,B,B_P,Read_Length,Read_Length2,Alignments,Alignments_P,Good_Alignments,Good_Alignments_P,H1,H1_P,Single_File,Quality_Score1,Quality_Score1_P,A1,A1_P,MapQ1,MapQ1_P,Max_Pass,mF,mC,fwfmi,revfmi);
		}	
		return;
	}
	
}
void Align_Map(READ & R,READ & M,BATREAD & B,char & source1,char & source2,int & mismatch,LEN & L_batmeth,BWT* fwfmi,BWT* revfmi,MEMX & MF,MEMX & MC,int & Paired_Score,READ & RawR,READ & RawM,OUTPUT & O1,OUTPUT & O2,Align_Hit & Align_Hits,Align_Hit & Align_Hits_P)
{
	...
	if(source1=='4')
	{
		...
		Next_Mis1=Last_Mis;
		Print_Hits(Paired_Score,RawR,Last_Mis,batmeth1,Align_Hits,source1,Genome_Offsets,readString,MC,L_batmeth,FALSE,revfmi,fwfmi,O1);
	}else if(source1=='1')
	{
		Hits=Map_Strand(Last_Mis,mismatch,maxhits,L_batmeth,fwfmi,revfmi,MF);
		Next_Mis1=Last_Mis;
		Print_Hits(Paired_Score,RawR,Last_Mis,batmeth1,Align_Hits,source1,Genome_Offsets,readString,MF,L_batmeth,FALSE,revfmi,fwfmi,O1);
	}
	...
	if(source2=='2')
	{
		Hits=Map_Strand(Last_Mis,mismatch,maxhits,L_batmeth,fwfmi,revfmi,MF);
		Next_Mis2=Last_Mis;
		Print_Hits(Paired_Score,RawM,Last_Mis,batmeth1,Align_Hits_P,source2,Genome_Offsets,readString,MF,L_batmeth,FALSE,revfmi,fwfmi,O2);
	}else if(source2=='3')
	{
		Hits=Map_Strand(Last_Mis,mismatch,maxhits,L_batmeth,fwfmi,revfmi,MC);
		Next_Mis2=Last_Mis;
		Print_Hits(Paired_Score,RawM,Last_Mis,batmeth1,Align_Hits_P,source2,Genome_Offsets,readString,MC,L_batmeth,FALSE,revfmi,fwfmi,O2);
	}
}
...
//	Get_Basic_MapQ(Good_Alignments_P,A1_P,MapQ1_P);
	...
	int mismatch=0;
	Align_Map(R,M,B,source1,source2,mismatch,L_batmeth,fwfmi,revfmi,MF,MC,Paired_Score,RawR,RawM,O1,O2,Align_Hits,Align_Hits_P);
	if(Align_Hits.H0.size()>1 && Align_Hits_P.H0.size()>1)
	{
		...
		if(Alignments_Reslut.size()>0) return;
	}
	{
		mismatch=1;
		Align_Map(R,M,B,source1,source2,mismatch,L_batmeth,fwfmi,revfmi,MF,MC,Paired_Score,RawR,RawM,O1,O2,Align_Hits,Align_Hits_P);
	...
	if(Align_Hits.H0.size()>0 || Align_Hits_P.H0.size()>0)
	{
	//	Do_SW(mis0);
		RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
...
//printf("\nsize %d %d %d %d %ld %ld\n",Good_Alignments.size(),Good_Alignments_P.size(),MapQ1,MapQ1_P,A1.Loc,A1_P.Loc);
	if(!(MapQ1 == -1 && MapQ1_P== -1))//if at least one end mapped 
	{
		if((MapQ1>0 && MapQ1_P>0) && (A1.Sign!=A1_P.Sign) && (Correct_Orientation(A1,A1_P)))//Proper pairing...
		{
			if(Proper_Pair(Alignments_Reslut,RawRTemp,RawRTemp_P,Original_Text,fwfmi,revfmi,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,Read_Length,Read_Length2,Alignments,Alignments_P,Good_Alignments,Good_Alignments_P,H1,H1_P,Single_File,Quality_Score1,Quality_Score1_P,A1,A1_P,mF,mC,Max_Pass))
			{
				return;
			}
		}
		...
		if(MapQ1 != -1 && MapQ1_P!= -1)//both mapped, maybe multiply or discordantly..
		{
			Full_Rescue(Alignments_Reslut,RawRTemp,RawRTemp_P,Original_Text,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,Read_Length,Read_Length2,Alignments,Alignments_P,Good_Alignments,Good_Alignments_P,H1,H1_P,Single_File,Quality_Score1,Quality_Score1_P,A1,A1_P,MapQ1,MapQ1_P,Max_Pass,mF,mC,fwfmi,revfmi);
			FreeQ(Alignments_P);FreeQ(Good_Alignments_P);
			FreeQ(Alignments);FreeQ(Good_Alignments);
		}
		else if(MapQ1_P!= -1)//Oneside mapped..
		{
			MapQ1=Map_hy_X(A1,source1,RawR,R,BTemp,MF,MC,MF2,MC2,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Mishit_File,Alignments,Good_Alignments,Pairs,Original_Text,fwfmi,revfmi,Conversion_Factor,Entries,RQHALF,RQ);
			if(MapQ1==-1) return;//need test here, I think is no need do align next.
			mF.ReadExtend=1;mC.ReadExtend=1;
			
			Detect_Paired(Original_Text,MapQ1,MapQ1_P,source1,source2,RawRTemp,RawRTemp_P,fwfmi,revfmi,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,Alignments,Good_Alignments,Alignments_P,Good_Alignments_P,Single_File,A1,A1_P,Alignments_Reslut);
			mF.ReadExtend=0;mC.ReadExtend=0;
		}
		else if(MapQ1!= -1)//Alignments not empty..
		{
			MapQ1_P=Map_hy_X(A1_P,source2,RawM,M,BTemp,MF,MC,MF2,MC2,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Mishit_File,Alignments_P,Good_Alignments_P,Pairs,Original_Text,fwfmi,revfmi,Conversion_Factor,Entries,RQHALF,RQ);
			if(MapQ1_P==-1) return;
			mF.ReadExtend=2;mC.ReadExtend=2;
			Detect_Paired(Original_Text,MapQ1,MapQ1_P,source1,source2,RawRTemp,RawRTemp_P,fwfmi,revfmi,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,Alignments,Good_Alignments,Alignments_P,Good_Alignments_P,Single_File,A1,A1_P,Alignments_Reslut);
			mF.ReadExtend=0;mC.ReadExtend=0;
		}
...
bool Find_Paired_New(int & Paired_Best_Score,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & A,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & B,std::map<unsigned,Alignment> & D,std::map<unsigned,Alignment> & D_P)
{
	int Pairings_Index=0;
	int Extra_Bit=200;
	Alignment Head,Tail;	
...
//printf("\n=-=-=-= %d %d\n",D.size(),D_P.size());
	for(std::map<unsigned,Alignment>::iterator I=D.begin();I!=D.end() && Pairings_Index<MAX_PROPER_PAIRS;/*I++*/)
	{
		...
		{//printf("\n%ld %ld %d %d %d\n",Nearest_Pair->first,I->first,Nearest_Pair->first-I->first,(Nearest_Pair->second).Score,(I->second).Score);
			...
			if (Correct_Orientation(I->second,Nearest_Pair->second,Extra_Bit))
			{
				...
				else if(Paired_Score >= (Head.Score+Tail.Score))
				{
					...
					Paired_Best_Score=Head.Score+Tail.Score;
		...
		if(Head.Score+Tail.Score < (I->second).Score) 
		{    
			D.erase(I++);
		}else I++;
...
void Remove_Dup_Alignment(std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_tmp,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::map<unsigned,Alignment> & D, std::map<unsigned,Alignment> & D_Res,int Ncutoff)
{
	ALIGNMENT_Q Alignments2=Alignments;
	//trans Alignments to map
	...
	//std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> Alignments_tmp2;
	while(!Alignments_tmp.empty())
	{
		Alignment A=Alignments_tmp.top();Alignments_tmp.pop();
		std::map<unsigned,Alignment>::iterator I;
		if((I=D.find(A.Loc))==D.end())
		{
			Alignments.push(A);
			//Alignments_tmp2.push(A);
			D[A.Loc]=A;
			if(A.Indel+A.Mismatch <= Ncutoff) D_Res[A.Loc]=A;
		}else if((I->second).Score < A.Score)
		{
			Alignments.push(A);
			//Alignments_tmp2.push(A);
			D[A.Loc]=A;
	...
	//Alignments_tmp=Alignments_tmp2;
	//FreeQ(Alignments_tmp2);
}

bool Deal_Alignment(bool & Unique,char source1,bool & flag,bool Last_Step,READ & RawR,READ & RawM,int Ncutoff,int & Paired_Ncutoff,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_tmp,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_tmp_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_P,unsigned char* Original_Text,READ & RTemp,BATREAD & BTemp,READ & RTemp_P,BATREAD & BTemp_P,int Read_Length,int Read_Length2)
{
	std::map<unsigned,Alignment> D_Map,D_Map_P;//Location -- alignment
	std::map<unsigned,Alignment> D_Res,D_Res_P;
	...
	// remove duplication in alignment_tmp
	Remove_Dup_Alignment(Alignments_tmp,Alignments,D_Map,D_Res,Ncutoff);//Alignments: store all Align hits.
	Remove_Dup_Alignment(Alignments_tmp_P,Alignments_P,D_Map_P,D_Res_P,Ncutoff);//Alignment_tmp: store align hits for current mismatch and step.
	
	if(D_Res.empty() && D_Res_P.empty())
		return false;

	std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> Alignments_Paired;//store align paired hits.
	std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> Alignments_Paired_P;
	
	bool uniqe=false;
	if(D_Map.size()==1 && D_Map_P.size()==1) uniqe=true;
	int Score_t=0;
	if( Find_Paired_New(Score_t,Alignments_Paired,Alignments_Paired_P,D_Map,D_Map_P) )
	{
		Alignment A,A_P;
		A=Alignments_Paired.top();A_P=Alignments_Paired_P.top();
		if(uniqe) flag=false;
		if(source1=='1' && (A.Indel+A.Mismatch+A_P.Indel+A_P.Mismatch)<Paired_Ncutoff ) Paired_Ncutoff=A.Indel+A.Mismatch+A_P.Indel+A_P.Mismatch;
		if( (A.Indel+A.Mismatch+A_P.Indel+A_P.Mismatch) <= Ncutoff || Last_Step || uniqe )
		{
			Alignments=Alignments_Paired;
			Alignments_P=Alignments_Paired_P;
			return true;
		}
	}
	//else
	{
		Rescue_One_Side(RawR,Original_Text,D_Res_P,Alignments_tmp_P,Alignments_tmp,RTemp,BTemp);
		Rescue_One_Side(RawM,Original_Text,D_Res,Alignments_tmp,Alignments_tmp_P,RTemp_P,BTemp_P);//Alignments_tmp Alignments_tmp_P

		D_Res.clear(); D_Res_P.clear();
		Alignments_Paired=Alignments_tmp;
		Alignments_Paired_P=Alignments_tmp_P;
		Unique=true;int paired_score=INT_MAX;
		if(Find_Paired(paired_score,Unique,Alignments_tmp,Alignments_tmp_P,D_Res,D_Res_P))
		{
			Alignment A,A_P;
			A=Alignments_tmp.top();A_P=Alignments_tmp_P.top();
			if(source1=='1' && (A.Indel+A.Mismatch+A_P.Indel+A_P.Mismatch)<Paired_Ncutoff ) Paired_Ncutoff=A.Indel+A.Mismatch+A_P.Indel+A_P.Mismatch;
			if( (A.Indel+A.Mismatch+A_P.Indel+A_P.Mismatch) <= Ncutoff || Last_Step )
			{
				Alignments=Alignments_tmp;
				Alignments_P=Alignments_tmp_P;
				return true;
			}
		}

		while(!Alignments_Paired.empty())
		{
			Alignment A=Alignments_Paired.top();Alignments_Paired.pop();
			std::map <unsigned,Alignment>::iterator I;
			if((I=D_Map.find(A.Loc))==D_Map.end())
			{
				Alignments.push(A);
			}
		}

		while(!Alignments_Paired_P.empty())
		{
			Alignment A=Alignments_Paired_P.top();Alignments_Paired_P.pop();
			std::map <unsigned,Alignment>::iterator I;
			if((I=D_Map_P.find(A.Loc))==D_Map_P.end())
			{
				Alignments_P.push(A);
			}
		}
...
void initial_MEMX(MEMX & M)
{
	M.Left_Mishits_Pointer=0;
        ...
        M.FMIndex=REVERSE;
	///
	really_free_M(M.Left_Mishits);
        really_free_M(M.Right_Mishits);
        really_free_M(M.Mismatches_Backward);
        really_free_M(M.Mismatches_Forward);
        really_free_M(M.Two_Mismatches_At_End_Forward);
        really_free_M(M.Two_Mismatches_At_End);
        really_free_M(M.Possible_20);
        really_free_M(M.Possible_02);
}
bool Map_One_Seg_New(int & mis_ID,int & mismatch,int & step,READ & RawR,char source,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,BATREAD & B,unsigned & Conversion_Factor,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,Final_Hit &  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,Pair* & Pairs,bool PRINT,Hit_Info & H,int & Quality_Score,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE)
{
	if(step>4) 
	...
	if(step==1)
	{
//		Map_One_SEG_Head(mismatch,RawR,source,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,L,Actual_Tag,Single_File,Mishit_File,Alignments,Good_Alignments,PRINT,H,Quality_Score,Segment_Length,SEG_SIZE,SHIFT_SEG_SIZE);
		step++;
		if(Alignments.size()) return true;
	}
	if(step==2)
	{
//		Map_One_SEG_Tail(mismatch,RawR,source,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF2,MC2,L,Actual_Tag,Single_File,Mishit_File,Alignments,Good_Alignments,PRINT,H,Quality_Score,Segment_Length,SEG_SIZE,SHIFT_SEG_SIZE);
		step++;
		if(Alignments.size()) return true;
	}
	if(step==3)
	{
//		Map_One_Half_Head(mismatch,RawR,source,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MFLH,MCLH,L_Half,Actual_Tag,Single_File,Mishit_File,Alignments,Good_Alignments,PRINT,H,Quality_Score);
		step++;
		if(Alignments.size()) return true;
	}
	if(step==4)
	{
//		Map_One_Half_Tail(mismatch,RawR,source,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MFLT,MCLT,L_Half,Actual_Tag,Single_File,Mishit_File,Alignments,Good_Alignments,PRINT,H,Quality_Score);
		step++;
		if(Alignments.size()) return true;
	}

	if(mismatch>=2 && mis_ID<=1)//1 0
        {    
  //      	Map_One_Quart_Head(mis_ID,RawR,source,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,MFH,MCH,MFT,MCT,L,L_Third,Actual_Tag,Single_File,Mishit_File,Alignments,Good_Alignments,PRINT,H,Quality_Score,SEG_SIZE,SHIFT_SEG_SIZE,Pairs);
		//
		if(!Alignments.size())
//			Map_One_Quart_Tail(mis_ID,RawR,source,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,MFH,MCH,MFT,MCT,L,L_Third,Actual_Tag,Single_File,Mishit_File,Alignments,Good_Alignments,PRINT,H,Quality_Score,SEG_SIZE,SHIFT_SEG_SIZE,Pairs);
		mis_ID++;
        }
...
void Two_Side_Hit_Finding(int & Paired_Ncutoff,char source1,char source2,READ & RawR,READ & RawM,int Read_Length,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,READ & M,BATREAD & B,unsigned & Conversion_Factor,MEMX & mF,MEMX & mC,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,FILE*  Single_File,FILE* Mishit_File,Align_Hit & Align_Hits,Align_Hit & Align_Hits_P,Pair* & Pairs,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE,std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut)
{
	...
	int mismatch=0;bool PRINT=false;bool FALSEt=false;bool TRUEt=true;
	Map_One_SEG_Head(Align_Hits.AM,mismatch,RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,L,Actual_Tag,Head_Hit,Mishit_File,Alignments_tmp,Good_Alignments_tmp,PRINT,H1,Quality_Score1,0,SEG_SIZE,0);
	Map_One_SEG_Head(Align_Hits_P.AM,mismatch,RawM,source2,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,M,B,Conversion_Factor,MF,MC,L,Actual_Tag,Mate_Hit,Mishit_File,Alignments_tmp_P,Good_Alignments_tmp_P,PRINT,H1_P,Quality_Score1_P,0,SEG_SIZE,0);
	Align_Hits.LH0=Alignments_tmp;
	Align_Hits_P.LH0=Alignments_tmp_P;
	if(Alignments_tmp.size()>0 || Alignments_tmp_P.size()>0)
	{
		combined5(Alignments,Align_Hits.H0,Align_Hits.H1,Align_Hits.H2,Align_Hits.LH0);//Alignments=Alignments+Align_Hits.H0+Align_Hits.H1+Align_Hits.H2+Align_Hits.LH0;
		combined5(Alignments_P,Align_Hits_P.H0,Align_Hits_P.H1,Align_Hits_P.H2,Align_Hits_P.LH0);//Alignments_P=Alignments_P+Align_Hits_P.H0+Align_Hits_P.H1+Align_Hits_P.H2+Align_Hits_P.LH0;
		...
		{
			Alignment_Pair C=Alignments_Reslut.top();
			if(C.paired==1 && (C.Indel<=2 && C.Mismatch==0) || (C.Indel==0 && C.Mismatch<=4) || (C.Indel<=1 && C.Mismatch<=2) ) return;
		}
	}
	
	Map_One_SEG_Tail(Align_Hits.AM,mismatch,RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF2,MC2,L,Actual_Tag,Head_Hit,Mishit_File,Alignments_tmp,Good_Alignments_tmp,PRINT,H1,Quality_Score1,0,SEG_SIZE,0);
	Map_One_SEG_Tail(Align_Hits_P.AM,mismatch,RawM,source2,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,M,B,Conversion_Factor,MF2,MC2,L,Actual_Tag,Mate_Hit,Mishit_File,Alignments_tmp_P,Good_Alignments_tmp_P,PRINT,H1_P,Quality_Score1_P,0,SEG_SIZE,0);
	Align_Hits.LT0=Alignments_tmp;
	Align_Hits_P.LT0=Alignments_tmp_P;
	if(Alignments_tmp.size()>0 || Alignments_tmp_P.size()>0)
	{
		combined2(Alignments,Align_Hits.LT0);//Alignments=Alignments+Align_Hits.LT0;
		combined2(Alignments_P,Align_Hits_P.LT0);//Alignments_P=Alignments_P+Align_Hits_P.LT0;
		RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
		Detect_result(0,0,FALSEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
		if(Alignments_Reslut.size()>0)
		{
	...
	Map_One_Half_Head(Align_Hits.AM,mismatch,RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MFLH,MCLH,L_Half,Actual_Tag,Head_Hit,Mishit_File,Alignments_tmp,Good_Alignments_tmp,PRINT,H1,Quality_Score1);
	Map_One_Half_Head(Align_Hits_P.AM,mismatch,RawM,source2,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,M,B,Conversion_Factor,MFLH,MCLH,L_Half,Actual_Tag,Mate_Hit,Mishit_File,Alignments_tmp_P,Good_Alignments_tmp_P,PRINT,H1_P,Quality_Score1_P);
	
	Align_Hits.SH0=Alignments_tmp;
	Align_Hits_P.SH0=Alignments_tmp_P;	
	if(Alignments_tmp.size()>0 || Alignments_tmp_P.size()>0)
	{
		combined2(Alignments,Align_Hits.SH0);//Alignments=Alignments+Align_Hits.SH0;
		combined2(Alignments_P,Align_Hits_P.SH0);//Alignments_P=Alignments_P+Align_Hits_P.SH0;
		RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
		Detect_result(0,0,FALSEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
		if(Alignments_Reslut.size()>0)
		{
	...
	Map_One_Half_Tail(Align_Hits.AM,mismatch,RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MFLT,MCLT,L_Half,Actual_Tag,Head_Hit,Mishit_File,Alignments_tmp,Good_Alignments_tmp,PRINT,H1,Quality_Score1);
	Map_One_Half_Tail(Align_Hits_P.AM,mismatch,RawM,source2,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,M,B,Conversion_Factor,MFLT,MCLT,L_Half,Actual_Tag,Mate_Hit,Mishit_File,Alignments_tmp_P,Good_Alignments_tmp_P,PRINT,H1_P,Quality_Score1_P);
	Align_Hits.ST0=Alignments_tmp;
	Align_Hits_P.ST0=Alignments_tmp_P;
	if(Alignments_tmp.size()>0 || Alignments_tmp_P.size()>0)
	{
		combined2(Alignments,Align_Hits.ST0);//Alignments=Alignments+Align_Hits.ST0;
		combined2(Alignments_P,Align_Hits_P.ST0);//Alignments_P=Alignments_P+Align_Hits_P.ST0;
		RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
		Detect_result(0,0,FALSEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
		if(Alignments_Reslut.size()>0)
		{
	...
	if(Alignments_tmp.size()>0 || Alignments_tmp_P.size()>0)
	{
		combined2(Alignments,Align_Hits.LH1);//Alignments=Alignments+Align_Hits.LH1;
		combined2(Alignments_P,Align_Hits_P.LH1);//Alignments_P=Alignments_P+Align_Hits_P.LH1;
		RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
		Detect_result(0,0,FALSEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
		if(Alignments_Reslut.size()>0)
		{
			Alignment_Pair C = Alignments_Reslut.top();
			if(C.paired==1 && (C.Indel==0 && C.Mismatch<=5) || (C.Indel<=1 && C.Mismatch<=3) || (C.Indel<=2 && C.Mismatch<=2) || (C.Indel<=3 && C.Mismatch==0) ) return;
		}
	}
	Map_One_SEG_Tail(Align_Hits.AM,mismatch,RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF2,MC2,L,Actual_Tag,Head_Hit,Mishit_File,Alignments_tmp,Good_Alignments_tmp,PRINT,H1,Quality_Score1,0,SEG_SIZE,0);
	Map_One_SEG_Tail(Align_Hits_P.AM,mismatch,RawM,source2,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,M,B,Conversion_Factor,MF2,MC2,L,Actual_Tag,Mate_Hit,Mishit_File,Alignments_tmp_P,Good_Alignments_tmp_P,PRINT,H1_P,Quality_Score1_P,0,SEG_SIZE,0);
	...
	if(Alignments_tmp.size()>0 || Alignments_tmp_P.size()>0)
	{
		combined2(Alignments,Align_Hits.LT1);//Alignments=Alignments+Align_Hits.LT1;
		combined2(Alignments_P,Align_Hits_P.LT1);//Alignments_P=Alignments_P+Align_Hits_P.LT1;
		RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
		Detect_result(0,0,FALSEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
		if(Alignments_Reslut.size()>0)
		{
	...
	if(Alignments_tmp.size()>0 || Alignments_tmp_P.size()>0)
	{
		combined2(Alignments,Align_Hits.SH1);//Alignments=Alignments+Align_Hits.SH1;
		combined2(Alignments_P,Align_Hits_P.SH1);//Alignments_P=Alignments_P+Align_Hits_P.SH1;
		RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
		Detect_result(0,0,FALSEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
		if(Alignments_Reslut.size()>0)
		{
	...
	if(Alignments_tmp.size()>0 || Alignments_tmp_P.size()>0)
	{
		combined2(Alignments,Align_Hits.ST1);//Alignments=Alignments+Align_Hits.ST1;
		combined2(Alignments_P,Align_Hits_P.ST1);//Alignments_P=Alignments_P+Align_Hits_P.ST1;
		RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
		Detect_result(0,0,FALSEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
		if(Alignments_Reslut.size()>0)
		{
	...
	combined2(Alignments,Align_Hits.LH2);//Alignments=Alignments+Align_Hits.LH2;
	combined2(Alignments_P,Align_Hits_P.LH2);//Alignments_P=Alignments_P+Align_Hits_P.LH2;
	RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
	...
	combined2(Alignments,Align_Hits.LT2);//Alignments=Alignments+Align_Hits.LT2;
	combined2(Alignments_P,Align_Hits_P.LT2);//Alignments_P=Alignments_P+Align_Hits_P.LT2;
	RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
	Detect_result(Best_Mis,Best_Indel,TRUEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
	if(Alignments_Reslut.size()>0)
	{
	...
	combined2(Alignments,Align_Hits.SH2);//Alignments=Alignments+Align_Hits.SH2;
	combined2(Alignments_P,Align_Hits_P.SH2);//Alignments_P=Alignments_P+Align_Hits_P.SH2;
	RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
	Detect_result(Best_Mis,Best_Indel,TRUEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
	if(Alignments_Reslut.size()>0)
	{
	...
	combined2(Alignments,Align_Hits.ST2);//Alignments=Alignments+Align_Hits.ST2;
	combined2(Alignments_P,Align_Hits_P.ST2);//Alignments_P=Alignments_P+Align_Hits_P.ST2;
	RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
	Detect_result(Best_Mis,Best_Indel,TRUEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
	if(Alignments_Reslut.size()>0)
	{
	...
	combined2(Alignments,Align_Hits.QH1);//Alignments=Alignments+Align_Hits.QH1;
	combined2(Alignments_P,Align_Hits_P.QH1);//Alignments_P=Alignments_P+Align_Hits_P.QH1;
	RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
	Detect_result(Best_Mis,Best_Indel,TRUEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
	if(Alignments_Reslut.size()>0)
	{
	...
	combined2(Alignments,Align_Hits.QH2);//Alignments=Alignments+Align_Hits.QH2;
	combined2(Alignments_P,Align_Hits_P.QH2);//Alignments_P=Alignments_P+Align_Hits_P.QH2;
	RTemp=RTemp2;RTemp_P=RTemp2_P;BTemp=BTemp2;BTemp_P=BTemp2_P;
	Detect_result(Best_Mis,Best_Indel,TRUEt,TRUEt,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,mF,mC,fwfmi,revfmi,RawRTemp,RawRTemp_P,Alignments,Alignments_P,Original_Text,Single_File,Alignments_Reslut,Good_Alignments,Good_Alignments_P);
...
void Rescue_One_Side_X_New(int mismatch,int Indel,READ & RawR,unsigned char* Original_Text,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment>  & Alignments_P,READ & RTemp_P,BATREAD & BTemp_P)
{
	...
	while(I!=D.end())
	{
		...
		if( (!(A1.Mismatch<=mismatch && A1.Indel<=Indel)) || A1.Rescued || A1.Do_Rescue)
		{
			Alignments.push(A1);
			I++;
			continue;
...
//printf("\nsource %c\n",source2);
	...
	A1=Alignments.top();
	T=Alignments;
//printf("CCCC %s %d %d %d %d\n",A1.Cigar,A1.Score,realign,mismatch,Indel);
...
//	printf("\n%d %d %d %d %d %d\n",mismatch,Indel,Alignments.size(),Alignments_P.size(),Do_Rescue,unique);
	Final_Hit Head_Hit,Mate_Hit;
...
void Mapping_New(int & Paired_Ncutoff,char source1,char source2,READ & RawR,READ & RawM,int Read_Length,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,READ & M,BATREAD & B,unsigned & Conversion_Factor,MEMX & mF,MEMX & mC,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,FILE*  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,Pair* & Pairs,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_Mid,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_Mid,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_End,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_End,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_Mid_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_Mid_P,std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut)
{
	...
	int Ncutoff=2; bool Find_Paired=false;
	int m1=0,m2=0; int step1=1,step2=1;
	int mism_ID1=0,mism_ID2=0;
	bool Last_Step=false;
	bool flag=true;bool Unique=true;
	
	while(!Find_Paired)
	{
		if(source1 =='4' && m1+m2+2>Paired_Ncutoff) return;
//	printf("\nStep1 %d %d %d %d %d\n",m1,m2,step1,step2,Paired_Ncutoff);
		if(m1>0)
		{
			initial_MEMX(MF);initial_MEMX(MC);initial_MEMX(MF2);initial_MEMX(MC2);initial_MEMX(MFLH);initial_MEMX(MCLH);
			initial_MEMX(MFLT);initial_MEMX(MCLT);initial_MEMX(MFH);initial_MEMX(MCH);initial_MEMX(MFT);initial_MEMX(MCT);
		}
		while(m1<=2 && !Map_One_Seg_New(mism_ID1,m1,step1,RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,MF2,MC2,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Head_Hit,Mishit_File,Alignments_tmp,Good_Alignments_tmp,Pairs,false,H1,Quality_Score1,0,SEG_SIZE,0))
		{
			m1++;
			step1=1;
			if(source1 =='4' && m1+2>Paired_Ncutoff) return;
		}
		if(m2>0)
		{
			initial_MEMX(MF);initial_MEMX(MC);initial_MEMX(MF2);initial_MEMX(MC2);initial_MEMX(MFLH);initial_MEMX(MCLH);
		...
		while(m2<=2 && !Map_One_Seg_New(mism_ID2,m2,step2,RawM,source2,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,M,B,Conversion_Factor,MF,MC,MF2,MC2,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Mate_Hit,Mishit_File,Alignments_tmp_P,Good_Alignments_tmp_P,Pairs,false,H1_P,Quality_Score1_P,0,SEG_SIZE,0) )
		{
			m2++;
			step2=1;
			if(source1 =='4' && m2+2>Paired_Ncutoff) return;
		}
		if(step1>4) 
		{
			step1=1;
...
//printf("\nStep %d %d %d %d %d\n",m1,m2,step1,step2,Paired_Ncutoff);
		if( ( (m1==0 && step1>4) || m1>0 ) && ((m2==0 && step2>4) || m2>0 ) || m1+m2>0 )
		{
			Ncutoff=3;
			if(m1+m2==2)
			{
		...
		if( (m1>2 && m2>2) || (m1==2 && m2==2 && step1>4 && step2>4 ))
			Last_Step=true;
		Find_Paired=Deal_Alignment(Unique,source1,flag,Last_Step,RawRTemp,RawRTemp_P,Ncutoff,Paired_Ncutoff,Alignments_tmp,Alignments,Alignments_tmp_P,Alignments_P,Original_Text,RTemp,BTemp,RTemp_P,BTemp_P,Read_Length,Read_Length2);
		if(Find_Paired) break;
		if( (m1>2 && m2>2) || (m1==2 && m2==2 && step1>4 && step2>4 ))
			break;
	}
	H1.Status=H1_P.Status=UNMAPPED;
	bool Hit1=Report_SW_Hits(RawRTemp,source1,Original_Text,0,RTemp,Head_Hit,Read_Length,BTemp,H1,Quality_Score1,Alignments,Good_Alignments,0/*Force_Indel*/,true,flag);
	bool Hit2=Report_SW_Hits(RawRTemp_P,source2,Original_Text,0,RTemp_P,Mate_Hit,Read_Length2,BTemp_P,H1_P,Quality_Score1_P,Alignments_P,Good_Alignments_P,0/*Force_Indel*/,true,flag);
	if(!Unique)
	{
		Head_Hit.Quality_Score=0;
		Mate_Hit.Quality_Score=0;
...
void Mapping(char source1,char source2,READ & RawR,READ & RawM,int Read_Length,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,READ & M,BATREAD & B,unsigned & Conversion_Factor,MEMX & mF,MEMX & mC,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,FILE*  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,Pair* & Pairs,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_Mid,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_Mid,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_End,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_End,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments_Mid_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments_Mid_P,std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut)
{
	...
	mF.batmeth1=false;mC.batmeth1=false;mC.ReadExtend=0;
		...
		Split_Read(Half,L_Half);
		Split_Read(SEG_SIZE/3,L_Third);
		Map_One_Seg(RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,MF2,MC2,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Head_Hit,Mishit_File,Alignments,Good_Alignments,Pairs,false,H1,Quality_Score1,0,SEG_SIZE,0);
		...
		if(PAIRED)
		{
			...
			Split_Read(Half,L_Half);
			Split_Read(SEG_SIZE/3,L_Third);
			Map_One_Seg(RawM,source2,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,M,B,Conversion_Factor,MF,MC,MF2,MC2,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Mate_Hit,Mishit_File,Alignments_P,Good_Alignments_P,Pairs,false,H1_P,Quality_Score1_P,0,SEG_SIZE,0);
			
			Get_top1M_Alignments(Alignments_P,Good_Alignments_P, cutoff);
			Get_Basic_MapQ(Good_Alignments_P,A1_P,MapQ1_P);
			bool Max_Pass=true;//(Read_Length2 - SEG_SIZE < 5)?true:false;
//	rintf("\nsize %d %d %d %d %c %c %d %d\n",Good_Alignments.size(),Good_Alignments_P.size(),MapQ1,MapQ1_P,A1.Sign,A1_P.Sign,A1.Loc,A1_P.Loc);		
			if(!(MapQ1 == -1 && MapQ1_P== -1))//if at least one end mapped 
			{
				if((MapQ1>0 && MapQ1_P>0) && (A1.Sign!=A1_P.Sign) && (Correct_Orientation(A1,A1_P)))//Proper pairing...
				{
				...
				if(Max_Pass)//cannot partition another reasonable seg..
				{
					...
					{
						Mate_Rescue(Alignments_Reslut,RawRTemp,RawRTemp_P,Original_Text,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,Read_Length,Read_Length2,Alignments,Alignments_P,Good_Alignments,Good_Alignments_P,H1,H1_P,Single_File,Quality_Score1,Quality_Score1_P,A1,MapQ1,mF,mC,fwfmi,revfmi);
					}
					else if(MapQ1_P!= -1)//Alignments not empty..
					{
						Mate_Rescue(Alignments_Reslut,RawRTemp_P,RawRTemp,Original_Text,source2,source1,RTemp_P,RTemp,BTemp_P,BTemp,Read_Length2,Read_Length,Alignments_P,Alignments,Good_Alignments_P,Good_Alignments,H1_P,H1,Single_File,Quality_Score1_P,Quality_Score1,A1_P,MapQ1_P,mF,mC,fwfmi,revfmi);

						//Mate_Rescue(Alignments_Reslut,RawR,RawM,Original_Text1,Original_Text2,source1,source2,RTemp_P,RTemp,BTemp_P,BTemp,Read_Length,Read_Length2,Alignments_P,Alignments,Good_Alignments_P,Good_Alignments,H1_P,H1,Single_File,Quality_Score1_P,Quality_Score1,A1_P,MapQ1_P,mF1,mC1,mF2,mC2,fwfmi1,revfmi1,fwfmi2,revfmi2);
					}
					return;
				}
			}
...
/*
		...
		RawRTemp=RawR;
		L_Main.STRINGLENGTH=SEG_SIZE;
		Split_Read(SEG_SIZE/2,L_Half);
		Split_Read(SEG_SIZE/3,L_Third);
		Map_One_Seg(RawR,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Head_Hit,Mishit_File,Alignments_Mid,Good_Alignments_Mid,Pairs,false,H1,Quality_Score1,0,SEG_SIZE,SHIFT_SEG_SIZE);
		...
		{
			int Read_Length2=M.Real_Len;
			//SW_THRESHOLD=80*Read_Length2*match/100;
			//int SEG_SIZE=75;
			//if(SEG_SIZE>=Read_Length2) SEG_SIZE=Read_Length2-1;
			//int SHIFT_SEG_SIZE=(2*SEG_SIZE>Read_Length2)? Read_Length2-SEG_SIZE-1:SEG_SIZE;
			...
			Split_Read(SEG_SIZE/2,L_Half);
			Split_Read(SEG_SIZE/3,L_Third);
			Map_One_Seg(RawM,source2,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,M,B,Conversion_Factor,MF,MC,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Mate_Hit,Mishit_File,Alignments_Mid_P,Good_Alignments_Mid_P,Pairs,false,H1_P,Quality_Score1_P,0,SEG_SIZE,SHIFT_SEG_SIZE);
			...
			if(!(MapQ1 == -1 && MapQ1_P== -1))//if at least one end mapped 
			{
				...
				else if(MapQ1_P!= -1)//Alignments not empty..
				{
					...
					//Mate_Rescue(RawR,RawM,Original_Text1,Original_Text2,source1,source2,RTemp_P,RTemp,BTemp_P,BTemp,Read_Length,Read_Length2,Alignments_P,Alignments,Good_Alignments_P,Good_Alignments,H1_P,H1,Single_File,Quality_Score1_P,Quality_Score1,A1_P,MapQ1_P,mF1,mC1,mF2,mC2,fwfmi1,revfmi1,fwfmi2,revfmi2);
				}
				return;
			}
			else
...
*/		
		...
		Split_Read(SEG_SIZE/2,L_Half);
		Split_Read(SEG_SIZE/3,L_Third);
		Map_One_Seg(R,source1,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,R,B,Conversion_Factor,MF,MC,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Head_Hit,Mishit_File,Alignments_Mid,Good_Alignments_Mid,Pairs,false,H1,Quality_Score1,0,SEG_SIZE,SHIFT_SEG_SIZE);
		...
		if(PAIRED)
		{
			...
			Split_Read(SEG_SIZE/2,L_Half);
			Split_Read(SEG_SIZE/3,L_Third);
			Map_One_Seg(M,source2,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,M,B,Conversion_Factor,MF,MC,MFLH,MCLH,MFLT,MCLT,MFH,MCH,MFT,MCT,L,L_Main,L_Half,L_Third,Actual_Tag,Mate_Hit,Mishit_File,Alignments_Mid_P,Good_Alignments_Mid_P,Pairs,false,H1_P,Quality_Score1_P,0,SEG_SIZE,SHIFT_SEG_SIZE);
			Fix_Offset(Alignments_Mid_P,Alignments_P,SHIFT_SEG_SIZE,NEG_SHIFT);
			...
			if(!(MapQ1 == -1 && MapQ1_P== -1))//if at least one end mapped 
			{
				if((MapQ1>0 && MapQ1_P>0) && (A1.Sign!=A1_P.Sign) && (Correct_Orientation(A1,A1_P)))//Proper pairing...
				{
					if(Proper_Pair(Alignments_Reslut,R,M,Original_Text,fwfmi,revfmi,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,Read_Length,Read_Length2,Alignments,Alignments_P,Good_Alignments,Good_Alignments_P,H1,H1_P,Single_File,Quality_Score1,Quality_Score1_P,A1,A1_P,mF,mC,Max_Pass))
					{
						return;
					}
				}
				if(MapQ1 != -1 && MapQ1_P!= -1)//both mapped, maybe multiply or discordantly..
				{
					Full_Rescue(Alignments_Reslut,R,M,Original_Text,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,Read_Length,Read_Length2,Alignments,Alignments_P,Good_Alignments,Good_Alignments_P,H1,H1_P,Single_File,Quality_Score1,Quality_Score1_P,A1,A1_P,MapQ1,MapQ1_P,Max_Pass,mF,mC,fwfmi,revfmi);
				}	
				else if(MapQ1!= -1)//Oneside mapped..
				{
					Mate_Rescue(Alignments_Reslut,R,M,Original_Text,Original_Text,source1,source2,RTemp,RTemp_P,BTemp,BTemp_P,Read_Length,Read_Length2,Alignments,Alignments_P,Good_Alignments,Good_Alignments_P,H1,H1_P,Single_File,Quality_Score1,Quality_Score1_P,A1,MapQ1,mF,mC,mF,mC,fwfmi,revfmi,fwfmi,revfmi);
				}
				else if(MapQ1_P!= -1)//Alignments not empty..
				{
					Mate_Rescue(Alignments_Reslut,M,R,Original_Text,Original_Text,source2,source1,RTemp_P,RTemp,BTemp_P,BTemp,Read_Length2,Read_Length,Alignments_P,Alignments,Good_Alignments_P,Good_Alignments,H1_P,H1,Single_File,Quality_Score1_P,Quality_Score1,A1_P,MapQ1_P,mF,mC,mF,mC,fwfmi,revfmi,fwfmi,revfmi);
					//Mate_Rescue(RawR,RawM,Original_Text1,Original_Text2,source1,source2,RTemp_P,RTemp,BTemp_P,BTemp,Read_Length,Read_Length2,Alignments_P,Alignments,Good_Alignments_P,Good_Alignments,H1_P,H1,Single_File,Quality_Score1_P,Quality_Score1,A1_P,MapQ1_P,mF1,mC1,mF2,mC2,fwfmi1,revfmi1,fwfmi2,revfmi2);
				}
				return;
			}
...
//if( (abs(A.Loc-991289706)<=10 || abs(A.Loc-12218526)<=10) && !strcmp(Ann.Name,"chr19")) printf("\nAAAAAA %d\n",A.Loc);
	...
	if(Aln->score1 >= Filter)
	{
		...
		//printf("\nCigar %s %d %d %d",A.Cigar,Cig_Info.Score,Cig_Info.Mis,StringLength);
		A.Loc=H.Org_Loc+Jump+Aln->ref_begin1;//+Offset;
/*
Ann_Info Ann;
unsigned int temp=A.Loc;
Location_To_Genome(temp,Ann);
//if( (abs(A.Loc-991289706)<=10 || abs(A.Loc-12218526)<=10) && !strcmp(Ann.Name,"chr19")) 
printf("\nAAAAAA %ld %d %d %s %d\n",A.Loc,temp,Cig_Info.Mis,Ann.Name,A.Do_Rescue);
*/
		A.Score= -Cig_Info.Score;
		A.QScore=Cig_Info.QScore;
		A.BQScore=Cig_Info.BQScore;
...
bool Report_Single(READ & RawR,unsigned char* Original_Text,READ & R,Final_Hit & Single_File,const int StringLength,BATREAD & Read,bool & Print_Status,int Clip_H,int Clip_T,Alignment & A)
{
	...
	Hit_Info H;
	assert(A.QScore!=INT_MAX);
	H.Org_Loc=A.Loc;H.Loc = A.Loc;H.Sign=A.Sign;H.QScore=A.QScore;H.Status=UNIQUEHIT;H.Indel=A.Indel;
	//A.Score= -A.Score;
	Location_To_Genome(H.Loc,Ann);H.Chr=Ann.Name;
	assert(A.Realigned);
...
void Map_One_Seg(READ & RawR,char source,RQINDEX & RQHALF,RQINDEX & RQ,unsigned char* Original_Text,unsigned Entries,BWT* fwfmi,BWT* revfmi,READ & R,BATREAD & B,unsigned & Conversion_Factor,MEMX & MF,MEMX & MC,MEMX & MF2,MEMX & MC2,MEMX & MFLH,MEMX & MCLH,MEMX & MFLT,MEMX & MCLT,MEMX & MFH,MEMX & MCH,MEMX & MFT,MEMX & MCT,LEN & L,LEN & L_Main,LEN & L_Half,LEN & L_Third,unsigned & Actual_Tag,Final_Hit &  Single_File,FILE* Mishit_File,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> & Good_Alignments,Pair* & Pairs,bool PRINT,Hit_Info & H,int & Quality_Score,int Segment_Length,int SEG_SIZE,int SHIFT_SEG_SIZE)
{
		...
		char T_EOS=R.Tag_Copy[SEG_SIZE+1],T_EOQ=R.Quality[SEG_SIZE+1];
		char T_EOS_raw=RawR.Tag_Copy[SEG_SIZE+1],T_EOQ_raw=RawR.Quality[SEG_SIZE+1];
		READ RMid=R;BATREAD BMid=B;READ RawR_Mid=RawR;
		if(SEG_SIZE)
		{
			//for(int i=0;i<=SHIFT_SEG_SIZE;i++)
			for(int i=0;i<=SEG_SIZE && (i+SHIFT_SEG_SIZE) < RawR.Real_Len;i++)
		...
		//Tail75
                READ R_Tail_SEG=RMid;BATREAD B_Tail_SEG=BMid;
                READ RawR_Tail_SEG=RawR_Mid;
		SHIFT_SEG_SIZE=RMid.Real_Len-SEG_SIZE-1;
                if(SEG_SIZE)
                {
                        //for(int i=0;i<=SHIFT_SEG_SIZE;i++)
                        for(int i=0;i<=SEG_SIZE && (i+SHIFT_SEG_SIZE) < RMid.Real_Len;i++)
                        {
                                assert((RMid.Tag_Copy[i+SHIFT_SEG_SIZE]>='A' && RMid.Tag_Copy[i+SHIFT_SEG_SIZE]<='t'));
                                R_Tail_SEG.Tag_Copy[i]=RMid.Tag_Copy[i+SHIFT_SEG_SIZE];
				R_Tail_SEG.Quality[i]=RMid.Quality[i+SHIFT_SEG_SIZE];
                                RawR_Tail_SEG.Tag_Copy[i]=RawR_Mid.Tag_Copy[i+SHIFT_SEG_SIZE];
				RawR_Tail_SEG.Quality[i]=RawR_Mid.Quality[i+SHIFT_SEG_SIZE];
                        }

                        R_Tail_SEG.Tag_Copy[SEG_SIZE+1]=0;
                        RawR_Tail_SEG.Tag_Copy[SEG_SIZE+1]=0;
                }

                RawR_Tail_SEG.Real_Len=R_Tail_SEG.Real_Len=R.Real_Len;

                if(Segment_Length)
                        R.Real_Len=Segment_Length;
		
                Process_Read(RawR_Tail_SEG,R_Tail_SEG,B_Tail_SEG,MF2,MC2);
                MF2.Strand='+';MF2.Larger_Than_Ten=0;MC2.Strand='-';MC2.Larger_Than_Ten=0;
                MF2.Extend=MC2.Extend=false;	
	...
	//25
		READ R_Head;BATREAD B_Head;
		READ RawR_Head;
		for (int i=0;i<L.STRINGLENGTH/3;i++) 
		{
			R_Head.Tag_Copy[i]=R.Tag_Copy[i]; 
			RawR_Head.Tag_Copy[i]=RawR.Tag_Copy[i];
		}
		...
		for (int i=0;i<L.STRINGLENGTH/3;i++) 
		{
			R_Tail.Tag_Copy[i]=R.Tag_Copy[i+L.STRINGLENGTH-L.STRINGLENGTH/3]; 
			RawR_Tail.Tag_Copy[i]=RawR.Tag_Copy[i+L.STRINGLENGTH-L.STRINGLENGTH/3];
		}
...
time_t Start_Time;
time(&Start_Time);
	//	Do_Mismatch_Scan('1',RawR,source,Original_Text,MF,MC,L,fwfmi,revfmi,0,Inter_MM,Last_Mis,Head_Top_Count,H,Quality_Score,R,B,Mishit_File,Conversion_Factor,Alignments,Good_Alignments);
		{N1++;
			//assert(Last_Mis==-1 || H.Cigar[0] || H.Cigar[1]=='Z'||L.STRINGLENGTH==R.Real_Len);
			//assert(L.STRINGLENGTH==R.Real_Len || Last_Mis== -1 || H.QScore != -1);
			time_t End_Time;
			time(&End_Time);
			time1+=difftime(End_Time,Start_Time);
			int Err=0;bool Force_Indel=false;
			if(BEST || (H.Status ==UNMAPPED) || !Alignments.size()|| Last_Mis==Inter_MM && Inter_MM > 2)
			{N2++;
				time(&Start_Time);
				std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> Alignments_tmp;
				std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment> Good_Alignments_tmp;
//				Do_Mismatch_Scan('2',RawR_Tail_SEG,source,Original_Text,MF2,MC2,L,fwfmi,revfmi,0,Inter_MM,Last_Mis,Tail_Top_Count,H,Quality_Score,R_Tail_SEG,B_Tail_SEG,Mishit_File,Conversion_Factor,Alignments_tmp,Good_Alignments_tmp);
			time(&End_Time);
			time2+=difftime(End_Time,Start_Time);
				Fix_Offset(Alignments_tmp,Alignments,SHIFT_SEG_SIZE+JUMP,SHIFT_SEG_SIZE+JUMP);
				Fix_Offset(Good_Alignments_tmp,Good_Alignments,SHIFT_SEG_SIZE+JUMP,SHIFT_SEG_SIZE+JUMP);
				if(BEST || (H.Status ==UNMAPPED) || !Alignments.size()||  Last_Mis==Inter_MM && Inter_MM > 2)
				{time(&Start_Time);N3++;
			        //50 head
			                READ R_Head_Half;BATREAD B_Head_Half;READ RawR_Head_Half;
			                int Half=50,SHIFT_Half=0;//RMid.Real_Len-Half;
			                for(int i=0;i<Half && (i+SHIFT_Half) < RMid.Real_Len;i++)
			                {    
			                        assert((RMid.Tag_Copy[i+SHIFT_Half]>='A' && RMid.Tag_Copy[i+SHIFT_Half]<='t'));
                        			R_Head_Half.Tag_Copy[i]=RMid.Tag_Copy[i+SHIFT_Half];
			                        R_Head_Half.Quality[i]=RMid.Quality[i+SHIFT_Half];
                        			RawR_Head_Half.Tag_Copy[i]=RawR_Mid.Tag_Copy[i+SHIFT_Half];
			                        RawR_Head_Half.Quality[i]=RawR_Mid.Quality[i+SHIFT_Half];
			                }    
			                R_Head_Half.Tag_Copy[Half]=0;
			                RawR_Head_Half.Tag_Copy[Half]=0;
			                R_Head_Half.Real_Len=RawR_Head_Half.Real_Len=Half;
     
			                B_Head_Half.StringLength=Half;B_Head_Half.NCount=0;B_Head_Half.IGNOREHEAD=0;
			                Process_Read(RawR_Head_Half,R_Head_Half,B_Head_Half,MFLH,MCLH);
			                MFLH.Strand='+';MFLH.Larger_Than_Ten=0;MCLH.Strand='-';MCLH.Larger_Than_Ten=0;
			                MFLH.Extend=MCLH.Extend=false;
			                MFLH.L=MCLH.L=L_Half;
//					Do_Mismatch_Scan('3',RawR_Head_Half,source,Original_Text,MFLH,MCLH,L_Half,fwfmi,revfmi,0,Inter_MM,Last_Mis,Head_Top_Count,H,Quality_Score,R_Head_Half,B_Head_Half,Mishit_File,Conversion_Factor,Alignments,Good_Alignments);
			time(&End_Time);
				time3+=difftime(End_Time,Start_Time);
				}
				if(BEST || (H.Status ==UNMAPPED) || !Alignments.size()|| Last_Mis==Inter_MM && Inter_MM > 2)
				{
				time(&Start_Time);N4++;
				//Tail 50
			                READ R_Tail_Half;BATREAD B_Tail_Half;READ RawR_Tail_Half;
			                int Half=50,SHIFT_Half=RMid.Real_Len-Half;//-1;
			                for(int i=0;i<Half && (i+SHIFT_Half) < RMid.Real_Len;i++)
			                {
                        			assert((RMid.Tag_Copy[i+SHIFT_Half]>='A' && RMid.Tag_Copy[i+SHIFT_Half]<='t'));
			                        R_Tail_Half.Tag_Copy[i]=RMid.Tag_Copy[i+SHIFT_Half];
                        			R_Tail_Half.Quality[i]=RMid.Quality[i+SHIFT_Half];
			                        RawR_Tail_Half.Tag_Copy[i]=RawR_Mid.Tag_Copy[i+SHIFT_Half];
			                        RawR_Tail_Half.Quality[i]=RawR_Mid.Quality[i+SHIFT_Half];
			                }
			                R_Tail_Half.Tag_Copy[Half]=0;
			                RawR_Tail_Half.Tag_Copy[Half]=0;
			                R_Tail_Half.Real_Len=RawR_Tail_Half.Real_Len=Half;
			                B_Tail_Half.StringLength=Half;B_Tail_Half.NCount=0;B_Tail_Half.IGNOREHEAD=0;
			                Process_Read(RawR_Tail_Half,R_Tail_Half,B_Tail_Half,MFLT,MCLT);
			                MFLT.Strand='+';MFLT.Larger_Than_Ten=0;MCLT.Strand='-';MCLT.Larger_Than_Ten=0;
			                MFLT.Extend=MCLT.Extend=false;
			                MFLT.L=MCLT.L=L_Half;
			
					FreeQ(Alignments_tmp);FreeQ(Good_Alignments_tmp);
	//				Do_Mismatch_Scan('4',RawR_Tail_Half,source,Original_Text,MFLT,MCLT,L_Half,fwfmi,revfmi,0,Inter_MM,Last_Mis,Tail_Top_Count,H,Quality_Score,R_Tail_Half,B_Tail_Half,Mishit_File,Conversion_Factor,Alignments_tmp,Good_Alignments_tmp);
					Fix_Offset(Alignments_tmp,Alignments,SHIFT_Half,SHIFT_Half);
					Fix_Offset(Good_Alignments_tmp,Good_Alignments,SHIFT_Half,SHIFT_Half);
				time(&End_Time);
				time4+=difftime(End_Time,Start_Time);
				}
				...
				if(BEST || (H.Status ==UNMAPPED) || Last_Mis==Inter_MM && Inter_MM > 2|| Force_Indel && Inter_MM > 2)
				{time(&Start_Time);N5++;
					Err=Do_Indel(source,RawR,RQHALF,RQ,Original_Text,Entries,fwfmi,revfmi,MF,MC,MFLT,MCLT,MFH,MCH,MFT,MCT,L.STRINGLENGTH,Pairs,R,Alignments,H);
				time(&End_Time);
				time5+=difftime(End_Time,Start_Time);
				}
			}
			...
			{	
				...
				if(!Report_SW_Hits(RawR,source,Original_Text,Err,R,Single_File,L.STRINGLENGTH,B,H,Quality_Score,Alignments,Good_Alignments,Force_Indel,PRINT))
				{
...
void Mate_Rescue_New(int mismatch,int Indel,bool & Do_Rescue,bool & realign,std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut,READ & RawR,READ & RawM,unsigned char* Original_Text,char source1,char source2,READ & RTemp,READ & RTemp_P,BATREAD & BTemp,BATREAD & BTemp_P,int Read_Length,int Read_Length2,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment>  & Alignments_tmp,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment>  & Alignments_tmp_P,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment>  & Good_Alignments,std::priority_queue <Alignment,std::vector <Alignment>,Comp_Alignment>  & Good_Alignments_P,Hit_Info & H1,Hit_Info & H1_P,FILE* Single_File,int Quality_Score1,int Quality_Score1_P,Alignment & A1,int MapQ2,MEMX & MF,MEMX & MC,BWT* fwfmi,BWT* revfmi)
{
	...
	if(realign)
		Adjust_Alignments(RawR,Original_Text,Alignments_tmp,0,RTemp,BTemp);
	ALIGNMENT_Q Alignments=Alignments_tmp;
//printf("\n%s %ld %d %d\n",Alignments_tmp.top().Cigar,Alignments_tmp.top().Loc,realign,RTemp.Real_Len);
...
void Print_Pair(std::priority_queue <Alignment_Pair,std::vector <Alignment_Pair>,Comp_Align_Pair> & Alignments_Reslut,Hit_Info &  HitsH,Hit_Info &  HitsT,char Sign1,char Sign2,READ & RawR,READ & RawM,unsigned char* Original_Text,char source1,char source2,FILE* Single_File,Final_Hit & H,Final_Hit & T,READ & R1, READ & R2,MEMX & MF,MEMX & MC,BWT* fwfmi,BWT* revfmi)
{
	...
	if (H.Loc != INT_MAX && T.Loc != INT_MAX)
	{
		...
		//if( H.Mismatch <=BP.MAX_MISMATCHES && T.Mismatch <=BP.MAX_MISMATCHES) //((R1.Real_Len*0.02+1 >= ed1) || (R2.Real_Len*0.02+1 >= ed2) ) && //MISMATCH
		{
			...
			Pai.QualityScore=H.Quality_Score+T.Quality_Score;Pai.Same_Chrom=Same_Chrome;Pai.Insert_Size=Insert_Size;
			Pai.Mismatch=Pai.Mismatch1+Pai.Mismatch2;
			if(Same_Chrome) Pai.paired=1;//true;
	...
	else 
	{
		...
		if (H.Loc == INT_MAX)
		{
			...
			//if( (R2.Real_Len*0.02+1 >= ed) && T.Mismatch <=BP.MAX_MISMATCHES)//T.Quality_Score>20 && !Print_hits &&
			{
				...
				Pai.Score=T.Score;Pai.Indel=T.Indel;
