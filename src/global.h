...
#include "rqindex.h"
	...
	#define __MAIN_INSERTED__
		...
		READ RawRead,revRawR,RawMead,revRawM;
		//BWT *fwfmi,*revfmi;
		BWT *fwfmiGA,*revfmiGA,*fwfmiCT,*revfmiCT;
		RQINDEX RQ,RQ_GA,RQ_CT;
		RQINDEX RQHALF,RQHALF_GA,RQHALF_CT;
		unsigned Entries;
		//unsigned Entries_Half;
		unsigned Entries_CT,Entries_GA;
		...
		int HITS_IN_SAM=150;//INT_MAX;//40;
		bool HEURISTIC=0;
		...
		char* DISC_HIT_BUFFER_ORG;
		#endif
		int32_t match=1, mismatch=2, gap_open=6, gap_extension=1, path, n, filter;
		int8_t* mata;
		int8_t* mata_SC;
	#endif
#else 
...
//extern BWT *fwfmi,*revfmi;
extern BWT *fwfmiGA,*revfmiGA,*fwfmiCT,*revfmiCT;
extern RQINDEX RQ,RQ_GA,RQ_CT;
extern RQINDEX RQHALF,RQHALF_GA,RQHALF_CT;
extern unsigned Entries;
//extern unsigned Entries_Half;
extern unsigned Entries_CT,Entries_GA;
