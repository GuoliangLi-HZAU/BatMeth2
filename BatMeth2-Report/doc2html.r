...
print(c, type='html', file=paste(output_dir, gsub("txt","",filename), "html", sep = ""), include.rownames = F, append = T, html.table.attributes = "class = 'mytable'")
