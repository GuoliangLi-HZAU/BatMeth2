...
extern bool DO_INDEL;
extern bool DO_INDEL_SMALL;
...
//      fprintf(stderr,"----------------------------------------------------------------------\n\n");
	...
	fprintf(stderr,"      --seed                        seed length for alignment. suggest: n/2. n = length of the read. if seed length short than 25, it will be very slow.\n");
        ...
        fprintf(stderr,"      --insertsize | -s             inital insert size, default 800\n");
        ...
        fprintf(stderr,"Note: To use BatMeth2, you need to first index the genome with `BatMeth2 build_index [opnion]`.\n\n");
}
void Parse_Command_line(int argc, char* argv[],char* & GENOME,unsigned & MAXCOUNT,FMFILES & F,BATPARAMETERS & BP)
{
	int Current_Option=0;
	const char* Short_Options ="C:c:e:E:d:D:f:F:x:X:s:ShHi:b:l::L:o:g:Pq:r:t:m:M:n:NbBw::R:Uu:v:Zj:p:I";//allowed options....
